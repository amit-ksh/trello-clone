...
import AppLabelPicker from "../../../components/AppLabelPicker.vue";
    ...
    >
      <div class="sm:flex">
        <main>
          ...
          <div class="form-group mt-10">
            ...
            <KEditor
              ...
              id="comments"
              :tools="[
                ['Bold', 'Italic', 'Undeline', 'Strikethrough'],
        ...
        >
          <ul class="m-auto">
            <li class="my-3">
              <strong class="text-xs mb-2 block">Task Label</strong>
              <AppLabelPicker
                :labels="[
                ...
                :selected="labels"
                @selectionUpdate="labels = $event as Label[]"
              />
            </li>

            <li class="my-3">
              <strong class="text-xs mb-2 block" for="calender">
                Task Due Date
              </strong>
              <KCalendar :views="1" v-model="taskCopy.dueAt" />
            </li>
          </ul>
        </aside>
      </div>
